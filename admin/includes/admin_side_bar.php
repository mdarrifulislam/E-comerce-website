<div id="sidebar-left" class="span2">
    <div class="nav-collapse sidebar-nav">
        <ul class="nav nav-tabs nav-stacked main-menu">
            ...
            <li><a href="sub_category.php"><i class="icon-tasks"></i><span class="hidden-tablet">Add Sub Category</span></a></li>
            <li><a href="manage_sub_category.php"><i class="icon-tasks"></i><span class="hidden-tablet">Manage Sub Category</span></a></li>
            ...
            <li><a href="customer_message.php"><i class="icon-font"></i><span class="hidden-tablet">Customer Message</span></a></li>
